...
function BgAbout() {
    return (
        <div>
            ...
            <Svg src={ZigZag}  top = {920} right={150} rotate="-10" scale="1"/>
            <Svg src={ZigZag}  top = {1100} left={150} rotate="-30" scale=".6"/>

            <Svg src={CutCircle}  top = {985} left={400} rotate="150" scale="0.9"/>
            <Svg src={CutCircle}  top = {1150} right={200} rotate="150" scale="0.5"/>

            <Svg src={FullCircle} top = {1200} left={500} rotate="-90" scale="0.5"/>

            <Svg src={AboutArc} top = {1140} left={-30} rotate="0" scale="1" zIndex="-1"/>
        </div>
    )
}
